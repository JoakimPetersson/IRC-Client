...
public class AddServerWindowController {
	...
	// Attempts to create the server based on the information filled out in the
	// add-server form
	...
	// Adds the server name to the server menu and adds the server-object to an
	// array called "serverList"
	/*
	 * private void addServerToList(ServerInfo server){ serverListArray.add(server);
